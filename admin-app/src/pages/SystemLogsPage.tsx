...
const CATEGORY: Record<AuditAction, string> = {
  ...
  driver_created: 'People',
  driver_removed: 'People',
  bus_created: 'Transport',
...
const FILTERS = ['All', 'People', 'Attendance', 'Communication', 'Academics', 'Fees', 'Transport'] as const;
