...
import { addMonths, subMonths, format, isSameDay, startOfMonth, endOfMonth, areIntervalsOverlapping } from 'date-fns';
import {
  AppText,
  Card,
  Chip,
...
export function AcademicCalendarScreen() {
  ...
  // Live subscription so events an admin adds, edits or removes show up
